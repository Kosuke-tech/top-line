    ...
    <div class="aboutTop__contentsWrapper">
        ...
        <div class="aboutTop__textWrapper">
            ...
            <p class="aboutTop__text">
                私たちは営業に関する支援のプロフェッショナル集団として、
                企業さまの成長を支える総合営業代理店です。<br>
                <br>
                業種や規模を問わず、多くのクライアント企業さまと共に課題を模索し、<br class="aboutTop__break1">
                最適な戦略に基づき、実行してきた実績があります。

                単なる営業の代行にとどまらず、現場に深く入り込み、
                売上拡大に直結する提案と行動で結果を出すことが私たちの強みです。<br>
                <br>
                信頼関係を何よりも大切にし、
                伴走型のハンズオンパートナーとして、クライアント企業さま、代理店企業さまの成長を長期的にご支援いたします。

                営業に関するあらゆる悩みに応えることで、次の一手を共に創り上げていきます。
            </p>
        </div>
    </div>
</section>
<section class="columnTop">
            ...
            <ul class="columnTop__list">
                <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
                    <li class="columnTop__listItem">
                        <a class="columnTop__cardLink" href="<?php the_permalink(); ?>">
    ...
    <div class="btn">
        <div class="btn__wrapper">
            <a class="btn__text" href="<?php echo esc_url(home_url('/column')); ?>">Read more</a>
        </div>
    </div>
</section>
...
<section class="businessTop">
    ...
    <div class="businessTop__wrapeer">
        ...
        <h3 class="businessTop__catch">「毎月かかるものだから、ムダなく、もっとおトクに。」</h3>
    ...
    <div class="btn">
        <div class="btn__wrapper">
            <a class="btn__text" href="<?php echo esc_url(home_url('/business')); ?>">Read more</a>
        </div>
    </div>
</section>
    ...
    <div class="recruitTop__textWrapper">
        <h3 class="recruitTop__catch">「その一歩が、あなたの未来を変える。」</h3>
            <p class="recruitTop__text">
                ...
                お客さまの課題に向き合い、最適な解決策を提案する“信頼”の仕事です。<br>
                <br>
                私たちは、そんな営業のプロフェッショナルを目指す仲間を募集しています。<br>
                <br>
                未経験でも大丈夫。大切なのは、「挑戦したい」という気持ちと、「人と真剣に向き合う姿勢」です。<br>
                <br>
                実践に近い研修制度と、先輩たちの丁寧なサポートにより、ゼロからでも確実にスキルが身につきます。<br>
                また、年齢や経験に関係なく、頑張りが正当に評価される仕組みも整えており、<br class="recruitTop__break1">
                キャリアアップも実力次第です。あなた自身の成長が、チームや会社の成長につながる環境です。<br>
                <br>
                営業の世界で自分の可能性を試したい方、人と関わることが好きな方、新しい一歩を踏み出したい方。 <br>
                その想い、私たちと一緒に叶えませんか？<br>
